defmodule KitchenCalculator do
  ...
  def from_milliliter({:milliliter, vol}, :fluid_ounce), do: {:fluid_ounce, vol / 30.0}
  def from_milliliter({:milliliter, vol}, :teaspoon), do: {:teaspoon, vol / 5.0}
  def from_milliliter({:milliliter, vol}, :tablespoon), do: {:tablespoon, vol / 15.0}
